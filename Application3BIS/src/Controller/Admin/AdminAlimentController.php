...
class AdminAlimentController extends AbstractController
{
     ...
     */
    public function ajoutEtModif(Aliment $aliment = null, Request $request, EntityManagerInterface $em)
    {
        if(!$aliment) {
            $aliment = new Aliment();
        }
     ...
     */
    public function suppression(Aliment $aliment, Request $request, EntityManagerInterface $em){
