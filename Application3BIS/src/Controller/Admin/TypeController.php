...
class TypeController extends AbstractController
{
     ...
     */
    public function ajoutEtModif(Type $type = null,Request $request, EntityManagerInterface $em)
    {
        if(!$type){
            $type = new Type();
        }
     ...
     */
    public function suppression(Type $type, EntityManagerInterface $em, Request $request)
    {
